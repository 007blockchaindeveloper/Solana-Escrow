        ...
        switch (_g.label) {
            ...
            case 8:
                ...
                if (newAliceYbalance !== aliceYbalance + terms.aliceExpectedAmount) {
                    (0, utils_1.logError)("Alice's Y balance should be ".concat(aliceYbalance + terms.aliceExpectedAmount, " but is ").concat(newAliceYbalance));
                    process.exit(1);
                }
            ...
            case 9:
                ...
                if (newBobXbalance !== bobXbalance + terms.bobExpectedAmount) {
                    (0, utils_1.logError)("Bob's X balance should be ".concat(bobXbalance + terms.bobExpectedAmount, " but is ").concat(newBobXbalance));
                    process.exit(1);
                }
